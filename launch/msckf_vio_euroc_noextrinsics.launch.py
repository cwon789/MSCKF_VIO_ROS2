...
def generate_launch_description():
  ...
  default_calibration = PathJoinSubstitution(
      [FindPackageShare("msckf_vio"), "config", "camchain-imucam-euroc-noextrinsics.yaml"]
  )
  ...
  return LaunchDescription(
      [
          ...
          DeclareLaunchArgument(
              ...
              description="EuRoC calibration without IMU extrinsics priors",
          ),
          Node(
              package="msckf_vio",
          ...
          Node(
              ...
              parameters=[
                  calibration_file,
                  {
                      ...
                      "initial_covariance.extrinsic_rotation_cov": 2.742e-3,
                      "initial_covariance.extrinsic_translation_cov": 4e-4,
                  },
              ],
              remappings=[
                  ("imu", "/imu0"),
